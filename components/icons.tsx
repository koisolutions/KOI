...
export function WebIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M3 9h18M7 6.5h.01M9.5 6.5h.01M12 6.5h.01" />
...
export function DeployIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M5 16.1A5 5 0 0 0 5.9 12M5 12.05A9 9 0 0 0 9.95 8M5 8A13 13 0 0 0 15 4M5 4A17 17 0 0 0 19 0" />
    </svg>
  );
}
...
export function SupportIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M18 2h-2.12a2 2 0 0 0-1.78 1.06L12 6" />
      <path d="M18 8h-2.12a2 2 0 0 1-1.78-1.06L12 2" />
    </svg>
  );
}
...
export function InvoiceIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M6 2h9l5 5v13a1 1 0 0 1-1.4.9L16 20l-2 1-2-1-2 1-2-1-2.6 1.9A1 1 0 0 1 4 21V4a2 2 0 0 1 2-2Z" />
...
export function TicketIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M21 8a3 3 0 0 1 0 8v2a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-2a3 3 0 0 1 0-8V6a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1z" />
